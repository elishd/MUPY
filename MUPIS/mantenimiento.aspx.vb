...
Public Class mantenimiento
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            connection.Close()
            connection.Open()
            Dim consu3 As String = "SELECT idproducto,Nombre FROM sql3221722.producto  where Existencia>0;"
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Dim con As String = "INSERT INTO `sql3221722`.`mantenimiento` (`fecha_mantenimiento`, `observacion`, `nombre_tecnico`,`costo`, `tipo`, `estado`, `medio_idmedio`) VALUES ('" + fecha_mantenimiento.Text + "' , '" +
            ...
            If base.Consulta(con) Then
                ...
                connection.Open()
                Dim consu2 As String = "SELECT max(idmantenimiento) as id FROM sql3221722.mantenimiento;"
