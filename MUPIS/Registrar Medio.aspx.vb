...
Public Class Registrar_Medio
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            If base.Consulta("INSERT INTO `sql3221722`.`medio` (`ubicacion`, `longitud`, `latitud`,`tipo`)" +
                ...
                connection.Open()
                Dim consu2 As String = "SELECT max(idmedio) as id FROM sql3221722.medio;"
                ...
                If (DropDownList1.SelectedValue = "Mupy") Then
                    base.Consulta("INSERT INTO `sql3221722`.`mupy` (`disponibilida`, `estado`, `cantidad_lado`, ` `cantidad_lado`,`," +
                ...
                ElseIf ((DropDownList1.SelectedValue = "Pantalla") Or (DropDownList1.SelectedValue = "Acroly")) Then
                    ...
                    base.Consulta("INSERT INTO `sql3221722`.`pantalla` (`estado`, `disponibilida`, `horasFuncionales`," +
